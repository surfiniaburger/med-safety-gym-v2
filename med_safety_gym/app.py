...
INCORRECT_ANSWER_PENALTY = float(os.environ.get("INCORRECT_ANSWER_PENALTY", -10.0))
CONFLICT_PENALTY = float(os.environ.get("CONFLICT_PENALTY", -15.0))
ABSTAIN_PENALTY = float(os.environ.get("ABSTAIN_PENALTY", -15.0))
MISSING_TRACE_PENALTY = float(os.environ.get("MISSING_TRACE_PENALTY", -20.0))

CORRECT_ABSTENTION_REWARD = float(os.environ.get("CORRECT_ABSTENTION_REWARD", 10.0))
VERIFIABLE_TRACE_REWARD = float(os.environ.get("VERIFIABLE_TRACE_REWARD", 5.0))
CORRECT_SYNTHESIS_REWARD = float(os.environ.get("CORRECT_SYNTHESIS_REWARD", 20.0))

EXACT_FORMAT_REWARD = float(os.environ.get("EXACT_FORMAT_REWARD", 10.0))
FORMAT_MISMATCH_PENALTY = float(os.environ.get("FORMAT_MISMATCH_PENALTY", -50.0))
NO_HALLUCINATION_REWARD = float(os.environ.get("NO_HALLUCINATION_REWARD", 15.0))
